...
tr:nth-child(even) {
 ...
 <jsp:useBean id = "user" type = "com.hit.Hibernate.User" scope="session"> 
	...
	<div data-role="page" id="home"   class="ui-body-a">
	 ...
	 <div data-role="panel"  data-display="push" id="Options"> 
		...
		<ul data-role="listview">
  		  ...
  		  <li><a href="Router?sendTo=chageItem">Change Item</a></li>
    	...
    	<%
    		...
    		if(itemsList != null){
    			for(Integer i=0 ;i <itemsList.size() ; i++)
    			{
    				...
    				out.print(" <a href='Router?sendTo=delete&itemId="+item.getId() + "&deleteType=item'  class='ui-btn ui-corner-all ui-shadow ui-btn-inline ui-icon-delete ui-btn-icon-left ui-btn-b'   >Delete </a> " );
